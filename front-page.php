...
<?php get_header(); ?>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p class="lead"><?php echo get_theme_mod( 'banner_text','Welcome to the WordPress Business Theme. This theme uses the Twitter Bootstrap 3 framework and can be cusomized to you style'); ?></p>
        <p><a class="btn btn-lg btn-primary" href="<?php echo get_theme_mod( 'banner_btn_url', 'https://bakerwebco.com') ?>" role="button"><?php echo get_theme_mod( 'banner_btn_text', 'Sign Up Today') ?></a></p>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="col-lg-4">
          <div class="block">
            ...
            <h3><?php echo get_theme_mod('box2_heading', 'Box 1 Heading' ); ?></h3>
